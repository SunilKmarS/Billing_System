...
## Prerequisites
- Java Development Kit (JDK) 8 or higher installed.
- MySQL database setup with the required tables and data.
- MySQL Workbench for running SQL scripts.

## Setup

### Step 1: Database Setup
1. **Run the Data.sql file in MySQL Workbench**:
    - Open MySQL Workbench.
    - Load and execute the `Data.sql` file to create the necessary tables and insert initial data.

### Step 2: Configure Database Connection
1. **Put Username and Password in db.properties file**:
    - Create a `db.properties` file in the project root directory.
    - Add the following content, replacing `your_username` and `your_password` with your MySQL credentials:
        ```
